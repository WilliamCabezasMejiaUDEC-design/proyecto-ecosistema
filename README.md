...
garantizando la privacidad de los datos mediante encriptación bcrypt en credenciales y logs de auditoría ambiental inmutables, asegurando una separación clara entre la trazabilidad privada de los generadores y el impacto público del dashboard.
